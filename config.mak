...
FFMPEG_CONFIG_MAK=1
FFMPEG_CONFIGURATION=--enable-debug=3 --disable-optimizations --disable-stripping
prefix=/usr/local
...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -U__STRICT_ANSI__ -D__USE_MINGW_ANSI_STDIO=1 -D__printf__=__gnu_printf__
CFLAGS=   -std=c99 -I/mingw/include/SDL -D_GNU_SOURCE=1 -Dmain=SDL_main -g3 -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign  -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -Wno-maybe-uninitialized
...
HOSTCPPFLAGS= -D_ISOC99_SOURCE -U__STRICT_ANSI__ -D__USE_MINGW_ANSI_STDIO=1 -D__printf__=__gnu_printf__
HOSTEXESUF=.exe
HOSTLDFLAGS= 
HOSTLIBS=-lm
DEPHOSTCC=gcc
...
CFLAGS-ffplay=-I/mingw/include/SDL -D_GNU_SOURCE=1 -Dmain=SDL_main
ZLIB=-lz
LIB_INSTALL_EXTRA_CMD=$$(RANLIB) "$(LIBDIR)/$(LIBNAME)"
EXTRALIBS=-lws2_32 -lavicap32 -lgdi32 -L/mingw/lib -lmingw32 -lSDLmain -lSDL -mwindows -mconsole -lm -lpsapi -ladvapi32 -lshell32 
COMPAT_OBJS=
EXEOBJS=
INSTALL=install
LIBTARGET=i386
...
LIBS-ffplay=-L/mingw/lib -lmingw32 -lSDLmain -lSDL -mwindows -mconsole
LIBS-ffprobe=
LIBS-ffserver=
LIBS-ffmpeg=
!ARCH_AARCH64=yes
